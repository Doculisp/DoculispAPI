...
2. [DoculispApi](#doculispapi)
3. [Document Parser](#document-parser)
4. [Tokenizer](#tokenizer)
5. [AST Parser](#ast-parser)
6. [Doculisp AST Parser](#doculisp-ast-parser)
7. [AST Project Parser](#ast-project-parser)
8. [Include Builder](#include-builder)
9. [String Writer](#string-writer)
10. [DoculispTypeScript Public Types](#doculisptypescript-public-types)
...
All API methods return [`Result<T>`](#resultt) types:
...
The API provides detailed error classification through [`FailureCategory`](#failurecategory):
...
Errors include [`ProcessingStep`](#processingstep) information showing where failures occurred:
